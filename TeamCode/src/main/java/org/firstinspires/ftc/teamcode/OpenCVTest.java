...
public class OpenCVTest extends LinearOpMode {
    ...
    /**
     * Links
     * http://overchargedrobotics.org/wp-content/uploads/2018/08/Advanced-Programming-Vision.pdf
     * https://www.gearbox4h.org/opencv/OpenCV_FTC_Tutorial.pdf
     *
     * https://ftcforum.usfirst.org/forum/ftc-technology/android-studio/49652-how-to-use-opencv-with-vuforia
     */
    ...
    @Override public void runOpMode() {
        ...
        while (!isStopRequested()) {
            ...
            if (targetVisible) {
                ...
                raw.setData(rawData);
                Vec2F pointCenter = Tool.projectPoint(this.vuforia.getCameraCalibration(), raw, new Vec3F(0, 0, 0));
                telemetry.addData("Center: " + (int) pointCenter.getData()[0] + ", " + (int) pointCenter.getData()[1], "");
                telemetry.update();*/
                ...
                for (int i = 0; i < numImages; i++) {
                    if (frame.getImage(i).getFormat() == PIXEL_FORMAT.RGB565) {
                        ...
                        if (rgb != null) {
                            ...
                            String filePath = "/sdcard/FIRST/opencv/rgbFile" + count + ".png";
                            telemetry.addData("Saving image" + filePath, "");
                            telemetry.update();
