...
public class fourBlockRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Point2D[][] stoneLocations = {
                ...
                {new Point2D(55,112), new Point2D(48,129)},
                {new Point2D(48,124), new Point2D(48,129)}
        };
...
//                    robot.cheesemode = true;
//                }
                if (time.seconds() > (toFoundation4Time + 1.5) && robot.stacker.getArmPosition() < 180 && !robot.stacker.stoneClamped) {
                    toFoundation4 = true;
                    time.reset();
                }
            }
