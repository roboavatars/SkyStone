...
//                        foundationPullThetaSpline.position(currentTime), 0.2, 0.2, 0.8);
                if(robot.drivetrain.currentheading>2*Math.PI/3){
                    ...
                    robot.drivetrain.setTargetPoint(30,55,Math.PI/2);
                }
